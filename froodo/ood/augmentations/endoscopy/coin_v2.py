...
class CoinV2Augmentation(OODAugmentation):
    ...
    def _augment(self, sample: Sample) -> Sample:
        ...
        path = f"froodo/ood/augmentations/endoscopy/artifacts/imgs/coin v2/{random.choice(listdir('froodo/ood/augmentations/endoscopy/artifacts/imgs/coin v2'))}"
