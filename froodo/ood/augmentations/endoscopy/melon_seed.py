...
class MelonSeedAugmentation(OODAugmentation):
    ...
    def _augment(self, sample: Sample) -> Sample:
        ...
        path = f"froodo/ood/augmentations/endoscopy/artifacts/imgs/melon seed/{random.choice(listdir('froodo/ood/augmentations/endoscopy/artifacts/imgs/melon seed'))}"
