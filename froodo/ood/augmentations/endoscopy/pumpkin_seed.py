...
class PumpkinSeedAugmentation(OODAugmentation):
    ...
    def _augment(self, sample: Sample) -> Sample:
        ...
        path = f"froodo/ood/augmentations/endoscopy/artifacts/imgs/pumpkin seed/{random.choice(listdir('froodo/ood/augmentations/endoscopy/artifacts/imgs/pumpkin seed'))}"
