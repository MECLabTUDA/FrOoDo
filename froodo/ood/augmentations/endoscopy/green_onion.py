...
class GreenOnionAugmentation(OODAugmentation):
    ...
    def _augment(self, sample: Sample) -> Sample:
        ...
        path = f"froodo/ood/augmentations/endoscopy/artifacts/imgs/green onion/{random.choice(listdir('froodo/ood/augmentations/endoscopy/artifacts/imgs/green onion'))}"
