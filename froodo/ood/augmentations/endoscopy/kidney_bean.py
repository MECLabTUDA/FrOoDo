...
class KidneyBeanAugmentation(OODAugmentation):
    ...
    def _augment(self, sample: Sample) -> Sample:
        ...
        path = f"froodo/ood/augmentations/endoscopy/artifacts/imgs/kidney bean/{random.choice(listdir('froodo/ood/augmentations/endoscopy/artifacts/imgs/kidney bean'))}"
