...
class OatsAugmentation(OODAugmentation):
    ...
    def _augment(self, sample: Sample) -> Sample:
        ...
        path = f"froodo/ood/augmentations/endoscopy/artifacts/imgs/oats/{random.choice(listdir('froodo/ood/augmentations/endoscopy/artifacts/imgs/oats'))}"
